              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="text-sm text-gray-500 text-center mt-3">
                    ในการลงทะเบียนล่วงหน้า คุณยินยอมที่จะได้รับอีเมลล์สำหรับการติดต่อจากทางเรา</div>
                </form>
                ...
                <div className="text-gray-600 text-center mt-6">
                  ได้รับ Access Key แล้ว? <Link to="/signin" className="text-blue-600 hover:underline transition duration-150 ease-in-out">เริ่มใช้งาน</Link>
                </div>
              </div>
